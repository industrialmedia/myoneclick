...
class MyoneclickFormBase extends FormBase implements ContainerInjectionInterface {
  ...
  protected function redirectToComplete($cart_id, FormStateInterface &$form_state) {
